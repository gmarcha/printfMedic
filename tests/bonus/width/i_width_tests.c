...
void    test_i_width(int testIndex) {
    ...
    int         (*test[NB_I_WIDTH_TESTS])() = {
        ...
        test_i_42_width_2,
        test_i_42_width_3,
        test_i_2147483647_width_10,
        test_i_2147483647_width_11,
        test_i_neg_1_width_2,
        test_i_neg_1_width_3,
        test_i_neg_42_width_3,
        test_i_neg_42_width_4,
        test_i_neg_2147483648_width_11,
        test_i_neg_2147483648_width_12
    };
    ...
    printf(FG_YELLOW"test : %%i with width\n"RESET);
    fflush(stdout);
    for (int i = 0; i < NB_I_WIDTH_TESTS; i++) {
        if (testIndex == 0 || testIndex == i + 1) {
            test_print(i + 1, expectedOutput[i], expectedReturnValue[i], test[i], input[i], "test_i_width");
        }
    }
    printf("\n");
}
