#ifndef X_WIDTH_PRECISION_DASH_TESTS_H
# define X_WIDTH_PRECISION_DASH_TESTS_H

# define NB_X_WIDTH_PRECISION_DASH_TESTS 14
...
#endif // X_WIDTH_PRECISION_DASH_TESTS_H
